...
| `auto+tdd` STATE-Test-Result trailer convention | STP-05 says "auto+tdd — autonomous with TDD cycle (RED→GREEN→REFACTOR commits required)". Trailer convention is implementation detail. | **No** — the trailer is the v41 mechanism; STP-05 wording covered. |
