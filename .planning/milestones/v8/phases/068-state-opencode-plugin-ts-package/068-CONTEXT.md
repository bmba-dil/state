# Phase 068: @state/opencode-plugin TS Package Scaffolding - Context
...
`package.json` peer deps per STACK.md; `tsconfig` extends `@tsconfig/node22`; `build: "tsc"`; `bun install`.
</domain>
