...
- [x] **DAG-05**: Priority inversion detection — warns when a soft dependency keeps a critical-path Slice blocked
- [x] **DAG-06**: Silent-deadlock detection — if all in-flight Slices are blocked on descoped/missing predecessors, surface to TUI
